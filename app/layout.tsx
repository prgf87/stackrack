...
const personSchema = {
  ...
  '@type': 'Person',
  name: 'Pedro Ferreira',
  alternateName: ['Stack Rack', 'Anthropod', 'Alien Devices', 'Systematic Audio'],
  description:
...
const websiteSchema = {
  ...
  name: 'Stack Rack',
  url: SITE_URL,
  description: 'Official website of Stack Rack — UK full-on psychedelic trance artist and DJ.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`scroll-smooth ${orbitron.variable} ${spaceGrotesk.variable}`}>
      <head>
        <script
      ...
      <body className="font-sans bg-[#0a0a0f] text-gray-300 antialiased">{children}</body>
    </html>
  );
}
